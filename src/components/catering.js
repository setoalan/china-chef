    ...
    return (
      <div className="row catering">
        <div className="col">
          ...
          <p>Includes choice of 3 entrées, 2 appetizers, white or fried rice, &amp; fortune cookies.</p>
          <h2>Combo C</h2>
          <h5>$8.45 Per Person*</h5>
          <p>Includes choice of 4 entrées, 2 appetizers, white or fried rice, &amp; fortune cookies.</p>
